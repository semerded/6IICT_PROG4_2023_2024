...
while running:
    ...
    # Als linkermuis is ingeduwd, zet hier een obstakel (door deze als Rect aan te maken & toe te voegen aan de lijst).
    if pygame.mouse.get_pressed()[0]:
        ...
        obstakel = pygame.Rect(x_positie_obstakel, y_positie_obstakel, afb_obstakel.get_width(), afb_obstakel.get_height()) # Maak obstakel aan.
    ...
    if rect_speler.collidelist(obstakels) != -1:
        mag_bewegen = False
    ...
    for obstakel in obstakels: frame.blit(afb_obstakel, (obstakel[0],obstakel[1])) # Teken obstakels.
